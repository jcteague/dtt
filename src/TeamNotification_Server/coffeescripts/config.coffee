...
staging_settings =
    ...
    site:
        ...
        client_ID: '1234'
        client_secret: 'secret'
        url: 'http://staging.dtt.local:3000'
        surl: 'https://staging.dtt.local:3001'
        whitelisted_paths: whitelisted_paths
    api:
        ...
        client_ID: '1234'
        client_secret: 'secret'
        url: 'https://api.staging.dtt.local:3001'
        whitelisted_paths: whitelisted_paths
    redis:
        host:'api.staging.dtt.local'
        port: 6379
    ...
    github:#FOR TEST PURPOSES, TODO: ask John for the real deal
        client_id: '238dc978aaf2621d38b5'
        secret: 'f86f03ae61ed557e0bb97cfbc25c5d0e43f0a350'
        redirect_url: 'http://api.staging.dtt.local:3000/github/auth/callback'
        state: 'zY6KPiIcKuhTYOdoUSX8avKc2mGASfNfHkvP50nAkPo='
    log:
        path: path.join(process.cwd(), 'development_logs', 'dev.log')
        token: ''
...
module.exports = ->
    switch process.env.NODE_ENV
        ...
        when 'staging' then staging_settings

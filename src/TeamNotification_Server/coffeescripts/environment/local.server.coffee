...
whitelisted_paths = ['/', '/client', '/api/', '/socket', /\/api\/user\/confirm\/*/, /\/api\/reset_password\/*/, /\/api\/forgot_password\/*/, '/api/registration','/api/user/login', '/api/plugin', /\/github\/events\/*/, /^\/api\/room\/.+\/accept-invitation$/]

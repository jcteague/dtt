define 'chat_room_view', ['general_view','messages_view','form_view','user_rooms_view','room_users_view'], (GeneralView, MessagesView, FormView, UserRoomsView,RoomUsersView) ->

...
using AvenidaSoftware.TeamNotification;

namespace TeamNotification_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TeamNotificationPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(AvenidaSoftware.TeamNotification.GuidList.guidTeamNotificationCmdSet, (int)AvenidaSoftware.TeamNotification.PkgCmdIDList.teamNotificationToolCommand);

    ...
    public class DateTimeFormatterSpecs
    {
        ...
        public class when_getting_the_formatted_element_and_the_date_is_today : when_getting_the_formatted_element
        {
            Establish context = () =>
            {
                ...
                chatMessage = new ChatMessageModel {date = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 11, 01, 0).ToString()};
            };
        ...
        public class when_getting_the_formatted_element_and_the_date_is_older_than_today : when_getting_the_formatted_element
        {
            ...
            {
                dateTime = DateTime.Now;
                chatMessage = new ChatMessageModel { date = new DateTime(dateTime.Year - 10, dateTime.Month, dateTime.Day, 11, 01, 0).ToString() };
            };
            ...
            It should_return_a_string_with_the_time = () =>
                result.GetText().ShouldEqual(DateTime.Parse(chatMessage.date).ToString("mm/dd/yyyy"));

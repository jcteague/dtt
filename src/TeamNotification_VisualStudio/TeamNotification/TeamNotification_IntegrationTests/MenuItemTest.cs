...
namespace TeamNotification_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(AvenidaSoftware.TeamNotification.GuidList.guidTeamNotificationCmdSet, (int)AvenidaSoftware.TeamNotification.PkgCmdIDList.teamNotificationToolCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "TeamNotification", "AvenidaSoftware.TeamNotification.TeamNotificationPackage");
